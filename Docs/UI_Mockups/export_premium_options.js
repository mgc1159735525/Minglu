...
const htmlPath = path.join(outDir, "redesign_premium_options.html");

const shots = [
  ["premium-a", "premium_option_a_gilded_academy.png", "高级A 鎏金军校"],
  ["premium-b", "premium_option_b_war_table.png", "高级B 战地沙盘"],
  ["premium-c", "premium_option_c_archive_book.png", "高级C 书院卷宗"]
];
...
async function makeContactSheet() {
  ...
  await sharp({
    ...
    .png()
    .toFile(path.join(outDir, "premium_options_overview.png"));
}
...
async function main() {
  ...
  console.log(path.join(outDir, "premium_options_overview.png"));
}
