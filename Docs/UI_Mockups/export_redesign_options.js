...
const htmlPath = path.join(outDir, "redesign_options.html");

const shots = [
  ["option-a", "redesign_option_a_imperial.png", "方案A 玄金学院"],
  ["option-b", "redesign_option_b_command.png", "方案B 军令桌案"],
  ["option-c", "redesign_option_c_journal.png", "方案C 书院手账"]
];
...
async function makeContactSheet() {
  ...
  await sharp({
    ...
    .png()
    .toFile(path.join(outDir, "redesign_options_overview.png"));
}
...
async function main() {
  ...
  console.log(path.join(outDir, "redesign_options_overview.png"));
}
